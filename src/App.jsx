          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
            ...
            <div className="os-compatibility">
              ...
              <svg className="os-icon linux" viewBox="0 0 24 24">
                <path d="M21 16.5c0 .38-.21.71-.53.88l-7.9 4.44a1.007 1.007 0 01-1.03 0l-7.9-4.44A1.001 1.001 0 013 16.5V7.5c0-.38.21-.71.53-.88l7.9-4.44c.16-.09.34-.14.57-.14.23 0 .41.05.57.14l7.9 4.44c.32.17.53.5.53.88v9z"/>
              </svg>
            </div>
          </div>
